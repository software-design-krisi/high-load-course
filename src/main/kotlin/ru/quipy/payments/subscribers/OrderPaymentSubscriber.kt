...
class OrderPaymentSubscriber {
    ...
    private val paymentExecutor = Executors.newFixedThreadPool(200, NamedThreadFactory("payment-executor"))

    @PostConstruct
    fun init() {
        subscriptionsManager.createSubscriber(OrderAggregate::class, "payments:order-subscriber", retryConf = RetryConf(5, RetryFailedStrategy.SKIP_EVENT)) {
